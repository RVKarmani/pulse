...
links:
  source: https://github.com/RVKarmani/pulse/blob/main/components/retroui/Tooltip.tsx
...
<ComponentInstall>
  <ComponentInstall.Cli npmCommand="npx shadcn@latest add 'https://retroui.dev/r/tooltip.json'" />
